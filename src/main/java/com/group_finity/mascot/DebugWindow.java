...
public class DebugWindow extends javax.swing.JFrame {
    ...
    public void setVisible(boolean b) {
        if (b) {
            lblBehaviour.setText(com.group_finity.mascot.Main.getInstance().getLanguageBundle().getString("Behaviour"));
            lblShimejiX.setText(com.group_finity.mascot.Main.getInstance().getLanguageBundle().getString("ShimejiX"));
            lblShimejiY.setText(com.group_finity.mascot.Main.getInstance().getLanguageBundle().getString("ShimejiY"));
            lblWindowX.setText(com.group_finity.mascot.Main.getInstance().getLanguageBundle().getString("WindowX"));
            lblWindowY.setText(com.group_finity.mascot.Main.getInstance().getLanguageBundle().getString("WindowY"));
            lblWindowWidth.setText(com.group_finity.mascot.Main.getInstance().getLanguageBundle().getString("WindowWidth"));
