...
public class Main {
    ...
    private final Hashtable<String, Configuration> configurations = new Hashtable<String, Configuration>();
    ...
    public void run() {
        ...
        try {
            ...
            if (!properties.containsKey("MenuDPI")) {
                ...
                if (dpi < 96)
                    dpi = 96;
                properties.setProperty("MenuDPI", String.valueOf(dpi));
                try {
    ...
    private void createTrayIcon() {
        ...
        try {
            // Create the tray icon
            final TrayIcon icon = new TrayIcon(ImageIO.read(new FileInputStream("img/icon.png")), languageBundle.getString("ShimejiEE"));
            ...
            icon.addMouseListener(new MouseListener() {
                ...
                public void mouseReleased(MouseEvent event) {
                    if (event.isPopupTrigger()) {
                        ...
                        try {
                            form.setIconImage(ImageIO.read(new FileInputStream("img/icon.png")));
                        } catch (IOException ex) {
                        }
